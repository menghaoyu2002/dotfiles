...
keys.globalkeys = gears.table.join(
    awful.key({ modkey,           }, "`",   function() awful.spawn("dm-tool switch-to-greeter") end,
              {description = "lock", group = "awesome"}),
    awful.key({ modkey,           }, "r",   function() awful.spawn("rofi -show run") end,
              {description = "show run launcher", group = "awesome"}),
    ...
    awful.key({ modkey }, "s", function () awful.spawn(apps.launcher, false) end),
    ...
    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.spawn.easy_async_with_shell("amixer set Master 3%-", function(stdout)
